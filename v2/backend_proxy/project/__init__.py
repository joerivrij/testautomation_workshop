...
def create_app():
    ...
    app.register_blueprint(proxy_blueprint, url_prefix='/v2/proxy/tokens')

    from project.api.user_controller import user_blueprint
    app.register_blueprint(user_blueprint, url_prefix='/v2/proxy/users')

    from project.api.movie_controller import movie_blueprint
    app.register_blueprint(movie_blueprint, url_prefix='/v2/proxy/movies')
